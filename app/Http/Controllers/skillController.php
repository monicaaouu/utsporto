...
class skillController extends Controller
{
    ...
    public function update(Request $request) {
        if($request->method() == 'POST') {
            ...
            [
                '_language.required'=>'Programming Language & Tools cant be empty',
                '_workflow'=>'Workflow cant be empty',
            ]);
            ...
            return redirect()->route('skill.index')->with('success', 'Update data skill successfully!');
        }
    }
}

            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div class="social-icons">
                        <a class="social-icon" href="https://www.linkedin.com/in/{{get_meta_value('_linkedin')}}/"><i class="fab fa-linkedin-in"></i></a>
                        <a class="social-icon" href="https://www.github.com/{{get_meta_value('_github')}}"><i class="fab fa-github"></i></a>
                        <a class="social-icon" href="https://www.twitter.com/{{get_meta_value('_twitter')}}"><i class="fab fa-twitter"></i></a>
                        <a class="social-icon" href="https://www.facebook.com/{{get_meta_value('_facebook')}}"><i class="fab fa-facebook-f"></i></a>
                        <a class="social-icon" href="https://www.instagram.com/{{get_meta_value('_instagram')}}"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            </section>
            <hr class="m-0" />

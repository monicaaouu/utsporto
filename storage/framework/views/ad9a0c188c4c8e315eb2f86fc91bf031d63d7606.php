    ...
    <form action="<?php echo e(route('education.store')); ?>" method="POST">
        ...
        <div class="mb-4">
            ...
            <input
                ...
                placeholder="GPA"
                step="0.01"
                value="<?php echo e(Session::get('info3')); ?>"
            />
        </div>
        <div class="mb-4">
            <div class="row">
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\portomonic\resources\views/dashboard/education/create.blade.php ENDPATH**/ ?>